...
public class ArchitecturalChangeHandled extends JPanel {
    private boolean DEBUG = false;
    public JTable table;
    public Object[][] data;
    public int entries;

    public ArchitecturalChangeHandled() {
        super(new GridLayout(1,0));
        String[] columnNames = {"architectural change handled", "enforcement status"};
        entries = 1;

/*******************************************************************************
 * Pattern signature of the kevoree.channel pattern
...
/**
 * Pattern-specific signature object of the kevoree.channel pattern.
...
public final class ChannelSignature extends BasePatternSignature implements IPatternSignature {
	...
	// constructor
	public ChannelSignature(Object CHA) {
		this.fCHA = CHA;	
	}
	...
	public Object get(String parameterName) {
		if ("CHA".equals(parameterName)) return fCHA;
		return null;
	}	
	
	public Object getValueOfCHA(){
		 return fCHA;
	}	
	...
	public void setValueOfCHA(Object CHA){
		 this.fCHA=CHA;
	}
	...
	public boolean equals(Object obj) {
		...
		if (fCHA == null) {if (other.fCHA != null) return false;}
		else if (!fCHA.equals(other.fCHA)) return false;
		return true;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((fCHA == null) ? 0 : fCHA.hashCode());
		return result;
	}
	...
	public String prettyPrint() {
		...
		result.append("\"CHA\"=" + prettyPrintValue(fCHA));
	...
	private static String[] parameterNames = {"CHA"};
